...
namespace Microsoft.Oryx.BuildScriptGenerator.DotNetCore
{
    ...
    internal class DotNetCorePlatform : IProgrammingPlatform
    {
        ...
        {
            var dotNetCoreDetectorResult = detectorResult as DotNetCorePlatformDetectorResult;
            if (dotNetCoreDetectorResult == null)
            {
                throw new InvalidOperationException(
                    $"Argument '{nameof(detectorResult)}' is not of type '{typeof(PlatformDetectorResult)}'.");
            }
            ...
            var projectFile = dotNetCoreDetectorResult.ProjectFile;
